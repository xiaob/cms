...
<html lang="en">
  <head>
    ...
    <title>FlatLab Frontend | Home   ${basePath}/</title>
    ...
    <link href="${basePath}/assets/bxslider/jquery.bxslider.css" rel="stylesheet" />
    <link href="${basePath}/assets/fancybox/source/jquery.fancybox.css" rel="stylesheet" />

    <link rel="stylesheet" href="${basePath}/assets/revolution_slider/css/rs-style.css" media="screen">
    <link rel="stylesheet" href="${basePath}/assets/revolution_slider/rs-plugin/css/settings.css" media="screen">
  ...
  <body>
    ...
    <script type="text/javascript" src="${basePath}/assets/bxslider/jquery.bxslider.js"></script>

    <script type="text/javascript" src="${basePath}/js/jquery.parallax-1.1.3.js"></script>

    <script src="${basePath}/js/jquery.easing.min.js"></script>
    <script src="${basePath}/js/link-hover.js"></script>

    <script src="${basePath}/assets/fancybox/source/jquery.fancybox.pack.js"></script>

    <script type="text/javascript" src="${basePath}/assets/revolution_slider/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
    <script type="text/javascript" src="${basePath}/assets/revolution_slider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

    <!--common script for all pages-->
    <script src="${basePath}/js/common-scripts.js"></script>

    <script src="${basePath}/js/revulation-slide.js"></script>

          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      <form id="my-awesome-dropzone" class="dropzone clickable" style="min-height:520px;" action="/admin/photo"><div class="default message" ><span>Drop files here to upload</span></div></form>

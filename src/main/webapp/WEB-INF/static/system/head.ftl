		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					<li class="">
						<a <#if menu="default">class="active"</#if> href="${BASE_PATH}/admin/index.htm"> <i class="icon-home"></i> <span>首页</span></a>
					</li>
					<li class="sub-menu">
						<a href="${BASE_PATH}/admin/folder/list.htm" <#if menu="folder">class="active"</#if>> <i class="icon-folder-open"></i> <span>目录</span></a>						
					</li>
					<li class="sub-menu">
						<a href="javascript:;" <#if menu="article">class="active"</#if>> <i class="icon-book"></i> <span>文章</span></a>
						<ul class="sub">
							<li <#if submenu="add_article">class="active"</#if>><a href="${BASE_PATH}/admin/article/add.htm">增加文章</a></li>
							<li <#if submenu="article_list">class="active"</#if>><a href="${BASE_PATH}/admin/article/list.htm">文章列表</a></li>
						</ul>
					</li>									
					<li class="sub-menu">
					...
					<li class="sub-menu ">
						...
						<ul class="sub">
							<li <#if submenu="system_basic">class="active"</#if>><a href="${BASE_PATH}/admin/config/basic.htm">基本设置</a></li>
							<li><a href="${BASE_PATH}/admin/admin/manage.htm">管理员管理</a></li>
							<li <#if submenu="update_admin">class="active"</#if>><a href="${BASE_PATH}/admin/admin/update.htm">修改个人信息</a></li>
						</ul>
					</li>
				</ul>
			</div>

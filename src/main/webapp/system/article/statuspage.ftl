            ...
            <section class="panel">
                ...
                <div class="panel-body">
                	<ul class="subsubsub">
						...
						<li class="arrticle_status"><a href="edit.php?post_status=publish&amp;post_type=post">已发布</a>（${displayCount}） |</li>
						<li class="arrticle_status"><a href="edit.php?post_status=draft&amp;post_type=post">草稿</a>（${draftCount}） |</li>
						<li class="arrticle_status"><a href="edit.php?post_status=private&amp;post_type=post">私有</a>（${privCount}） |</li>
						<li class="arrticle_status"><a href="edit.php?post_status=trash&amp;post_type=post">密码保护</a>（${secretCount}）</li>
					</ul>
				</div>
                <div class="panel-body">
                	<div class="adv-table">

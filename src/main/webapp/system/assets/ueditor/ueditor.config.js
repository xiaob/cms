...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:window.BasePath + "/admin/ueditor/photo/upload.htm"             //图片上传提交地址
        ,imagePath:window.BasePath                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //图片在线管理配置区
        ,imageManagerUrl:window.BasePath + "/admin/ueditor/photo/manager.htm"       //图片在线管理的处理地址
        ,imageManagerPath:window.BasePath                                    //图片修正地址，同imagePath
...
>>>>>>> branch 'develop' of git@git.oschina.net:shishuo/CMS.git
